...
// One-token top-6 router specialization for Apple SIMD width 32. Scores and
// ids stay in registers within a SIMD group; only bitonic stages that cross a
// 32-lane boundary use the two alternating threadgroup banks. The six route
// weights are finalized in the same dispatch and preserve the legacy serial
// denominator and scaling order.
