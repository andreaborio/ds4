...
- In the long-context C-completion regression, require the first generated byte
  to be `>` and reject the known corruption markers `unistdFlush`, `stdiint`,
  `stdintFlush`, `stdioFlush`, and `errnoFlush`.
