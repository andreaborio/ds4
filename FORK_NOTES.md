...
| Exact paired Q8 Metal decode (2026-07-20 long-context candidate) | compute two independent Q8 matvec outputs in one exact Metal dispatch while preserving bit-identical accumulation order | **FORK RELEASE CANDIDATE; M5 METAL ONLY** — Qwen 32K A/B/B/A kept throughput neutral (+0.057%) and reduced mean p95 from 337.329 to 334.230 ms (-0.92%), beyond both control and candidate spread. All arms had identical evidence and zero swap; the final-source 128+128 smoke measured 349.74/59.97 t/s. Other Apple families retain the exact scalar dispatch. Do not advertise a general t/s gain. |
