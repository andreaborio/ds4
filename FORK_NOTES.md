...
| DeepSeek phase-adaptive long-context cache (2026-07-20 candidate) | shrink the ExpertMajor cache only during large prefill, restore 4,129 records through 32K or 2,065 at 65K+, pressure-gate growth, seed once after success, and enter lower-memory tiers 128 tokens before each hard frontier | **FORK CANDIDATE; M5 64 GB FINAL RERUN OPEN** — the preceding candidate measured 161.68/8.46 and 137.04/7.46 prefill/decode t/s at 8K/32K. Isolated AUTO-to-SSD 65K/100K measured 141.61/5.72 and 126.72/5.58 with zero swap; the rejected 4,129-record 65K arm swapped before decode. Non-M5 Apple systems retain the generic cache path. |
