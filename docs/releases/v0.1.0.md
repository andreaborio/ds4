...
> [!NOTE]
> Historical release record, not current startup guidance. ExpertMajor v1,
> `ds4-qwen-pack`, canonical inference, and sidecars were retired after this
> release. Current Qwen, DeepSeek, and GLM inference requires ExpertMajor v2 on
> Apple Metal and starts without an ExpertMajor environment flag.
