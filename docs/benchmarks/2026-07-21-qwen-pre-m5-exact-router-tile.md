...
- Implementation commit: `d612c0c`; flag-free cleanup commit: `f3d3ee2`;
  final qualified branch tree: `5e54fea`.
...
The final squash also passed the complete M5 `premerge` suite with Metal source
SHA-256
`d111d28f5c3f8856ad27909297448a2f54ac3e9635882c5457deaf487a2e8ca8`.
